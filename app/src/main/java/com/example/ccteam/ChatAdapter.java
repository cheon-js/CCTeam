...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if(item.getName().equals(G.nickName)){
            itemView= layoutInflater.inflate(R.layout.activity_my_msgbox,viewGroup,false);
        }else{
            itemView= layoutInflater.inflate(R.layout.activity_other_msgbox,viewGroup,false);
        }
